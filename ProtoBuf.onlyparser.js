...
/*
 * modified by marchtea 
 * remove decode and encode function 
 * also remove Long.js dependencies
 * add some fix, now can run on ie browsers evan before IE10.
 *
 *
*/

//deal eval function before ie8 and before 
var code_evaled;
...
(function(global) {
	...
	// deal Object.keys in ie browser
        ...
        ProtoBuf.Reflect = (function(ProtoBuf) {
            ...
            Message.prototype.build = function() {
                ...
                var clazz = (function(Reflect, T) {
                     ...
                     * @type {!Function}
                     */
                    var Message = eval_global("(function "+T.name+"() { this.__construct.apply(this, arguments); })");
